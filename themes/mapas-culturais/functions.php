...
function custom_menus() {
    register_nav_menu('main-menu',__( 'Menu Principal', 'mapas-culturais' ));
    register_nav_menu('footer-menu', __( 'Menu de Rodapé', 'mapas-culturais' ));
    register_nav_menu('social-networks', __( 'Redes Sociais', 'mapas-culturais' ));
}
...
function pagination() {
    ...
    if ( $wp_query->max_num_pages > 1 ) {
        ...
        echo paginate_links( array(
            ...
            'prev_text' => __( '<' , 'mapas-culturais' ) ,
            'next_text' => __( '>' , 'mapas-culturais' )
        ) );
    }
}
...
function site_by_hacklab($args = []){
    ...
    <div class="site-by-hacklab">
        ...
        <a href="<?php echo wp_get_theme()->get('AuthorURI') ?>">hacklab<b>/</b></a>
    </div>
    <?php
}
